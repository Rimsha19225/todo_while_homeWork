...
;
let a = 0;
let guest = ["bisma", "aamna", "safia", "rohi", "laiba"];
console.log(`\n\n ********** Guest List **********\n`);
...
// index type define
console.log(`\n\n ********** Tuples in Simple **********\n`);
let mobileBrands = ["Nokia", "iPhone", "Matrola", "Samsong"];
console.log(mobileBrands);
console.log(`\n\n ********** Tuples in Dynamic **********\n`);
let Stuents_01 = ["rimsha", 24, true];
let Stuents_02 = ["fadi", 20, false];
let Stuents_03 = ["samra", 21, true];
let Stuents_04 = ["danyal", 23, false];
let Stuents_05 = ["warda", 26, true];
let display = (person) => {
